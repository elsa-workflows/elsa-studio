...
namespace Elsa.Studio.Authentication.ElsaAuth.HttpMessageHandlers;

/// <summary>
/// An <see cref="HttpMessageHandler"/> that attaches an ElsaAuth JWT access token to outgoing HTTP requests.
/// </summary>
/// <remarks>
...
/// </remarks>
public class ElsaAuthAuthenticatingApiHttpMessageHandler(IBlazorServiceAccessor blazorServiceAccessor) : DelegatingHandler
{
    /// <inheritdoc />
