/**
 * Elsa Studio Complete Loader for Blazor Hosted WebAssembly
 * This script handles all initialization including CSS, scripts, loading screen, and Blazor startup
 * with custom configuration support
 * Usage: <script src="_content/Elsa.Studio.Shared/js/elsa-studio-loader-hosted-wasm.js"></script>
 */
...
(function() {
    ...
    // Load Blazor framework script
    function loadBlazorScript(callback) {
        if (document.querySelector('script[src="_framework/blazor.webassembly.js"]')) {
    ...
    // Initialize Blazor WASM with custom configuration
